...
<!-- INICIO DEL DIV DE OPCIONES -->
            <div class="div-opciones">
                ...
                <div class="div-a">
                    ...
                    <div class="div-input">
                        <input name="input-titulo" value="<?php echo $titulo;?>">
                    </div>               
                </div>
                <div class="div-a">
                    <a>Descripción del anuncio</a>
                    <div class="div-input">
                        <input name="input-descripcion">
                    </div>               
                </div>
                <div class="div-a">
                    <a>Precio</a>
                ...
                <div class="div-a">
                    <a>Recámaras</a>
                    <div class="div-input">
                        <input name="input-recamaras">
                    </div>               
                </div>
                <div class="div-a">
                    <a>Baños</a>
                    <div class="div-input">
                        <input name="input-baños">
                    </div>               
                </div>
                <div class="div-a">
                    <a>Medios baños</a>
                    <div class="div-input">
                        <input name="input-medbañ">
                    </div>               
                </div>
                <div class="div-a">
                    <a>Estacionamientos</a>
                    <div class="div-input">
                        <input name="input-estacionamientos">
                    </div>               
                </div>
                <div class="div-a">
                    <a>Construcción</a>
                    <div class="div-input">
                        <input name="input-construccion">
                    </div>               
                </div>
                <div class="div-a">
                    <a>Terreno</a>
                    <div class="div-input">
                        <input name="input-terreno">
                    </div>               
                </div>
                <div class="div-a">
                    <a>Número de pisos del edificio</a>
                    <div class="div-input">
                        <input name="input-pisos">
                    </div>               
                </div>
                <br><br>
                ...
                <div class="div-a">
                    ...
                    <div class="div-input">
                        <input name="input-ciudad">
                    </div>               
                </div>
                <div class="div-a">
                    <a>Dirección</a>
                    <div class="div-input">
                        <input name="input-direccion">
                    </div>               
                </div>
