    ...
    <div>
        <form class="dropdowns mx-3">
            ...
            <div class="mx-2 my-2">
                <label>Precio:</label>
                <div class="d-flex">
                    <input id="min" name="min" class="form-control" type="min" placeholder="Min:" aria-label="min">
                    <input id="max" name="max" class="form-control" type="max" placeholder="Max:" aria-label="max">
                </div>
            </div>
            <button class=" form-control btn btn-outline-info ms-5" type="submit">Buscar</button>
        </form>
    </div>
