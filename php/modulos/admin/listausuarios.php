...
<div class="container">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <Button class="btn btn-outline-info my-3"><i class="fa-solid fa-user-plus"></i> Agregar</Button>
    </div>
    <hr class="sidebar-divider">
    <div class="row">
    <select name="estado" id="estado" class="form-control col-4">
        ...
        <input id="buscar" name="buscar" class="form-control col-6" type="buscar" placeholder="Buscar" value="">
        <button class=" form-control btn btn-outline-info ms-5 col-2" type="submit">Buscar</button>
    </div>
